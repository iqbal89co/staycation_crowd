...
<body>
	...
	<div class="container">
		<div class="booking-card pd-text m-4 radius">
			...
			<form action="<?= base_url("/Hotel/bookRoom/$room->id_room") ?>" method="post" class="trip-form needs-validation"
				novalidate>
				<!-- User's name -->
				<div class="form-row">
					<input type="text" name="name" class="form-control from-place" placeholder="Your name" required>
				</div>
				<!-- User's email -->
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="phone_number" class="form-control from-place" id="inputPhone"
				...
				<div class="form-group row">
					<div class="form-group col-12 col-md-6">
						...
						<input type="datetime-local" name="check_in" class="form-control" id="checkIn" required>
					</div>
					<!-- Check out date -->
					<div class="form-group col-12 col-md-6">
						<label for="checkOut">Check-Out</label>
						<input type="datetime-local" name="check_out" class="form-control" id="checkOut" required>
					</div>
				</div>
				<div class="mb-3">
					<!-- Guest type -->
					...
					<div class="w-100">
						...
						<input type="number" value="0" hidden readonly min="0" class="ctDewasa" name="adults" required>
